...
use quickmark_linter::config::{
    ...
    MD022HeadingsBlanksTable, MD024MultipleHeadingsTable, MD025SingleH1Table, MD029OlPrefixTable,
    MD033InlineHtmlTable, MD046CodeBlockStyleTable, MD048CodeFenceStyleTable, QuickmarkConfig,
    RuleSeverity,
};
